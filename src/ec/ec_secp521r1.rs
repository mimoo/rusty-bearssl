...
//! secp521r1 (NIST P-521) domain parameters (`src/ec/ec_secp521r1.c`).

use super::{br_ec_curve_def, BR_EC_secp521r1};
...
/// see inner.h
pub static br_secp521r1: br_ec_curve_def = br_ec_curve_def {
